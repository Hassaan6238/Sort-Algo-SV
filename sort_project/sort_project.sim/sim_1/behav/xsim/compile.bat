...
REM
REM Generated by Vivado on Mon Jul 28 23:41:44 -0400 2025
...
echo "xvlog --incr --relax -L uvm -prj Top_mod_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Top_mod_tb_vlog.prj -log xvlog.log
